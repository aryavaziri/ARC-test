...
const Tabs: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center w-full">
            <div className="flex bg-gray-100 rounded-full p-1 w-full justify-evenly">
                {tabs.map((tab, index) => {
                    ...
                    return (
                        <div
                            key={tab.key}
                            className={`w-full transition-all border-r border-gray-300 whitespace-nowrap ${(isLast || isActive || isHovered || isPrev)
                                    ? "border-r-0"
                                    : ""
                                }`}
                        >
